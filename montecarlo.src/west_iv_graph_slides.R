...
outputfile <- "montecarlo/west_iv_slides.pdf"
datafile <- "montecarlo.full/west_iv.csv"
...
d$P <- factor(d$P)
d$T <- paste("T =", d$T)
pdf(outputfile, width = 7, height = 3.5)
dotplot(P ~ Size | T, d, groups = Method, layout = c(2,1),
        cex = 1.2,
