...
and the null is that the expeted squared loss is the same.  This
approach is approrpiate when one wants to use the forecast performance
...
regardless of the actuall statistic.
...
statisitc that ignores this source of error can have rejection
...
overreject for any of the parameterizations we consider. The test
