...
from~\eqref{eq:25}. (See the proof of Theorem~1 in \citealp{Cal:16c},
...
\begin{proof}[Proof of~\eqref{eq:27}]
  ...
  \end{equation}
  Pointwise convergence holds from the \lln\ \citep{Cal:16c} and
...
as~\citet{Wes:96} with minor tweaks as in \citet[Lemma A.2]{Cal:16}
...
\end{gather}
As in \citet{Cal:16}, our assumptions ensure that $h_t$ is an
...
\begin{proof}
  ...
  We will use arguments very similar to \cite{Cal:16c}. Define
  \[
